...
| backuparr | 1.2.0 | 1.2.0 | Automated backup solution for *arr applications using their native APIs |
...
| jellyfin | 0.10.0 | 10.11.6 | A Helm chart for Kubernetes for deploying Jellyfin Media Server |
